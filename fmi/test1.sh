...
SPLIT=%SPLIT%       # e.g. 1 dataset = 10 pieces, 2 datasets=100 pieces, ...  (10-20 is a good number usually).
JOBS=%JOBS%	       # number of tasks to run in parallel. Vroom=4/8, db04=8, vroom2=16/32.

# Name of destination schema. Change this.
RESULT_SCHEMA='public'

# Name of table for the final results. Change this.
RESULT_TABLE='inter_big'
...
DB_LOGIN='/usr/local/pgsql-9.6/bin/psql -p 5439 nicolas'
